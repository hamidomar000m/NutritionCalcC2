...
public class MainFrame {
	...
	private void initialize() {
		...
		JButton ernährungsempfehlungBtn = new JButton("Ern\u00E4hrungsempfehlung");
		...
		JFreeChart pieChart = ChartFactory.createPieChart("Nährstoffverteilung", pieDataSet,  true,  true,  true);
		...
		JLabel makronährstoffeLbl = new JLabel("Makron\u00E4hrstoffe");
		...
		JLabel mikronährstoffeLbl = new JLabel("Mikron\u00E4hrstoffe");
